...
def mostrar_menu():
    ...
    unidades = {
  #permite encontrar las carpetas principales que se van agregando
        '1': 'SEMANA 1',
        '2': 'SEMANA 2',
        '3': 'SEMANA 3',
        '4': 'SEMANA 4',
...
# mientras pressonemos el cero vamos a salir a los menus principales y secundarios
    while True:
...
#imprime los sub menus de las carpetas principales
    while True:
...
# en esta opcion se puede ver la ejecucion
# de los programas que se encuentran dentro de las carpetas y subcarpetas
    while True:
